...
`status:closed` `2026-03-09T09:00:00.000Z` `[architecture, planning]`
...
`status:active` `2026-03-13T10:00:00.000Z` `[security, edge-cases]`
...
`status:blocked` `2026-03-14T09:00:00.000Z` `[security, infrastructure]`
